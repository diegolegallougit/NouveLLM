        ...
        <div className="bg-white rounded-2xl border border-[#D8D8D8] p-8 max-w-md w-full text-center space-y-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button onClick={() => {
              ...
              {copied ? (
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2E7D32" strokeWidth="2.5" strokeLinecap="round"><path d="M20 6L9 17l-5-5" /></svg>
              ) : (
            ...
            <div className="px-1 py-1.5 rounded-lg bg-[#F2F2F2] text-center">
              <p className="text-xs break-all" style={{ fontFamily: 'monospace', color: '#5A5A5A', fontSize: '0.7rem' }}>
                {result.link}
              </p>
            </div>
