      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          {userRole === 'ADMIN' && (
            <a
              href="/admin"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] text-white transition-all"
              style={{ background: '#00068D', fontFamily: 'Gilroy, sans-serif', fontWeight: 800, letterSpacing: '0.06em' }}
